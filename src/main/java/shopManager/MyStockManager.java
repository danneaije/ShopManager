...
public class MyStockManager implements StockManager{
	...
	public void clean() {
		...
		try{
			myInstance.save();
			trazador.info("El repositorio es válido , persistimos los datos y luego limpiamos");
		}
		catch(UnknownRepo e) {
			
			//Si el repositorio no fuera válido, lanza la excepción, que capturamos aquí
			trazador.info("El repositorio no es válido (null), no se puede persistir, aún así, limpiamos");
		}
